...
namespace iBank.Services.Orm.WebQueries
{
    public class GetAllLoadLogQuery : IQuery<IList<LoadLogViewModelDisplayData>>
    {
        private iBankMastersEntities _db;
        private SearchLoadLogViewModel _searchParameters;
        public GetAllLoadLogQuery(iBankMastersEntities db, SearchLoadLogViewModel searchParameters)
        {
            _db = db;
