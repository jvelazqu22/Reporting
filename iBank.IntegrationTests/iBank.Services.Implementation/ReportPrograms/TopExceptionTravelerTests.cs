...
{
    [TestClass]
    public class TopExceptionTravelerTests : BaseUnitTest
    {
        ...
        public void BackOfficeDepartureDate()
        {
            ...
            Assert.AreEqual(18, rpt.FinalDataList.Sum(s => s.NumOccurs), "Total Stays is incorrect");
            Assert.AreEqual(6166.19m, rpt.FinalDataList.Sum(s => s.LostAmt), "Total Cost is incorrect");
        ...
        public void ReservationDepartureDate()
        {
            ...
            Assert.AreEqual(10, rpt.FinalDataList.Count, "Count is incorrect");
            Assert.AreEqual(10, rpt.FinalDataList.Sum(s => s.NumOccurs), "Total Stays is incorrect");
            Assert.AreEqual(51982.27m, rpt.FinalDataList.Sum(s => s.LostAmt), "Total Cost is incorrect");
        ...
        public void ReservationInvoiceDate()
        {
            ...
            Assert.AreEqual(10, rpt.FinalDataList.Count, "Count is incorrect");
            Assert.AreEqual(10, rpt.FinalDataList.Sum(s => s.NumOccurs), "Total Stays is incorrect");
            Assert.AreEqual(49102.20m, rpt.FinalDataList.Sum(s => s.LostAmt), "Total Cost is incorrect");
        ...
        public void ReservationBookedDate()
        {
            ...
            Assert.AreEqual(10, rpt.FinalDataList.Count, "Count is incorrect");
            Assert.AreEqual(10, rpt.FinalDataList.Sum(s => s.NumOccurs), "Total Stays is incorrect");
            Assert.AreEqual(119065.93m, rpt.FinalDataList.Sum(s => s.LostAmt), "Total Cost is incorrect");
        ...
        public void GenerateReportHandoff(DateType dateType)
        {
            ...
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "PROCESSID", ParmValue = "62", ParmInOut = "IN", LangCode = "" });
