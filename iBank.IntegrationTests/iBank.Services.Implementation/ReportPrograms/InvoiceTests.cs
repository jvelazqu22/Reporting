...
{
    [TestClass]
    public class InvoiceTests : BaseUnitTest
    {
       ...
       */
        ...
        private void GenerateReportHandoffRecordsNoData()
        {
            ...
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "PROCESSID", ParmValue = "27", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "PROGRAM", ParmValue = "ibInvoice", ParmInOut = "IN", LangCode = "" });
        ...
        {
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "AGENCY", ParmValue = "DEMO", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "BEGDATE", ParmValue = "DT:2014,2,25", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "BRANCH", ParmValue = "", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "CARDNUM", ParmValue = "", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "country", ParmValue = "United States", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "DATERANGE", ParmValue = "4", ParmInOut = "IN", LangCode = "" });
        ...
        public void BackOfficeReportDepartureDate()
        {
            ...
            //Check that there is the right number of RawData records. 
            ...
            Assert.AreEqual(84, rpt.FinalDataList.Count, "Final data records failed.");
            
            ClearReportHandoff();
        }

        [TestMethod]
        public void BackOfficeReportDepartureDateInvoiceMethod()
        {
            GenerateBackOfficeHandoffRecords(DateType.DepartureDate,"2");
        ...
        [TestMethod]
        public void BackOfficeReportDepartureDateInvoiceByAgencyMethod()
        {
            GenerateBackOfficeHandoffRecords(DateType.DepartureDate,"3");
        ...
        [TestMethod]
        public void BackOfficeReportBookedDate()
        {
            GenerateBackOfficeHandoffRecords(DateType.BookedDate);
            ...
            //Check that there is the right number of RawData records. 
            Assert.AreEqual(6, rpt.RawDataList.Count, "Raw data records failed.");
            //Check that there is the right number of FinalData records. 
            Assert.AreEqual(25, rpt.FinalDataList.Count, "Final data records failed.");
        ...
        private void GenerateBackOfficeHandoffRecords(DateType dateRangeType, string invByAgency = "1")
        {
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "AGENCY", ParmValue = "DEMO", ParmInOut = "IN", LangCode = "" });
            ...
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "DATERANGE", ParmValue = "4", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "DOMINTL", ParmValue = "1", ParmInOut = "IN", LangCode = "" });
            ReportHandoff.Add(new ReportHandoffInformation { ParmName = "DDINVBYAGCY", ParmValue = "1", ParmInOut = "IN", LangCode = "" });
            ...
            ManipulateReportHandoffRecords(invByAgency, "DDINVBYAGCY");
