...
namespace iBank.Services.Implementation.ReportPrograms.TravelDetail
{
    public class TopTravAllCarbonCalc
    {
        ...
        public void AddCarbonEmissionsToFinalData(List<TopTravAllFinalData> finalData, TravDetShared travDetShared, bool useMileageTable, bool useMetric, string carbonCalculator, bool isPreview)
        {
        ...
        public void CalculateCarbonEmissionForAirDataAndUpdateFinalData(List<TopTravAllFinalData> finalData, TravDetShared travDetShared, bool useMileageTable, bool useMetric, string carbonCalculator)
        {
            ...
            {
                List<TopTravAllFinalData> finalDataByRecLoc = finalData.Where(w => w.RecLoc.Equals(recLoc)).ToList();
        ...
        public void CalculateCarbonEmissionForCarDataAndUpdateFinalData(List<TopTravAllFinalData> finalData, TravDetShared travDetShared, bool useMetric, bool isPreview)
        {
        ...
        public void CalculateCarbonEmissionForHotelDataAndUpdateFinalData(List<TopTravAllFinalData> finalData, TravDetShared travDetShared, bool useMetric, bool isPreview)
        {
