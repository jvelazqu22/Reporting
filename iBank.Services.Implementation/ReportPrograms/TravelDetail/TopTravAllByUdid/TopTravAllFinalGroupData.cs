...
namespace iBank.Services.Implementation.ReportPrograms.TravelDetail.TravelDetailByUdid
{
    public class TopTravAllFinalGroupData
    {
        ...
        public static List<TopTravAllByUdidFinalData> GetGroupFinalData(List<TopTravAllByUdidFinalData> finalDataList)
        {
            var results = finalDataList.GroupBy(s => new { s.passfrst, s.passlast },
                (key, g) =>
                {
                    ...
                    var finalData = new TopTravAllByUdidFinalData
                    {
        ...
        public static void UpdateDaysInTheRoad(List<TopTravAllByUdidFinalData> finalDataList, List<TopTravAllByUdidFinalData> groupedFinalDataList)
        {
