...
{
    public class IataDest : IColumnValue
    {
        ...
        {
            return LookupFunctions.LookupRegion(LookupFunctions.LookupSegRouteFirstDestination(_reportLookups.Segs, _mainRec.RecKey), _mainRec.Valcarr, 
                _masterStore, _isTitleCaseRequired);
        }
    }
}
