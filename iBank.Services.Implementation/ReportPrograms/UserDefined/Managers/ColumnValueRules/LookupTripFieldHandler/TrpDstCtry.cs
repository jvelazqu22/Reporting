...
{
    public class TrpDstCtry : IColumnValue
    {
        ...
        {
            return LookupFunctions.LookupCountry(_masterStore, LookupFunctions.LookupSegRouteFirstDestination(_reportLookups.Segs, _mainRec.RecKey), _isTitleCaseRequired, _mainRec.Valcarr);
        }
    }
}
