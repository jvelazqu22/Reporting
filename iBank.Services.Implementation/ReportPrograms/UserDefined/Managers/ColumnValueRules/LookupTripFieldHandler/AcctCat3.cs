...
{
    public class AcctCat3 : IColumnValue
    {
        ...
        {
            return LookupFunctions.LookupAccountCategory(_clientFunctions, new GetAllMasterAccountsQuery(_clientStore.ClientQueryDb, _globals.Agency), _mainRec.Acct, 3);
        }
    }
}
