...
{
    public class VendTypes : IColumnValue
    {
        ...
        public string CalculateColValue()
        {
            ...
            {
                if (_sharedLogic.CalcTripSummaryField(_mainRec.Recloc, _column.Name))
                {
            ...
            return LookupFunctions.LookupVendorType(_reportLookups.VendorTypes, _mainRec.RecKey);
        }
