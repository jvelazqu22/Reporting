...
{
    public class Account : IColumnValue
    {
        ...
        {
            return _clientFunctions.LookupCname(new GetAllMasterAccountsQuery(_clientStore.ClientQueryDb, _globals.Agency), _mainRec.Acct, _globals);
