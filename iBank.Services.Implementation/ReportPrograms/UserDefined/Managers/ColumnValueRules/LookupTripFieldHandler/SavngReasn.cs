...
{
    public class SavngReasn : IColumnValue
    {
        ...
        {
            return LookupFunctions.LookupRegion(LookupFunctions.LookupSegRouteFirstOrigin(_reportLookups.Segs, _mainRec.RecKey), _mainRec.Valcarr, _masterStore, _isTitleCaseRequired);
        }
    }
}
